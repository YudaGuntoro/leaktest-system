...
const modalInputClass = "mt-2 h-10 w-full rounded-lg border border-slate-300 bg-white px-3 text-sm font-medium text-slate-900 outline-none transition placeholder:text-slate-400 focus:border-brand-400 focus:ring-3 focus:ring-brand-500/20 dark:border-slate-600 dark:bg-transparent dark:text-white dark:placeholder:text-slate-400";
      ...
      >
        <form onSubmit={(event) => void submit(event)}>
          ...
          <div className="px-6 pb-2 pt-7">
            <h2 className="text-xl font-black text-slate-900 dark:text-white">{editingOperator ? "Update Operator" : "Create Operator"}</h2>
          </div>
